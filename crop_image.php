...
/*控制预览图大小*/
.crop_preview{float:left;margin-left:20px;width:200px;height:200px;overflow:hidden;}
.clear{clear:both}
.btn{cursor:pointer}
.tl{text-align:left}
	...
	$(document).ready(function(){
		...
		$("#confirmOk").click(function(){
			...
			if (parseInt($('#w').val())){
				...
				var w = $("#w").val();
				var h = $("#h").val();
				$.post('/?m=user&a=upload_avatar1',{pic_name:pic_name,x:x,y:y,w:w,h:h},function(data){
					if(data.status==1){
