...
$(function(){
    //验证
	$('#J_password_form').submit(function(){
		var f=1;
		if($("#J_password").val().length<6){$("#J_passwordTip").css("display",'inline-block');f=0;}
		if($("#J_repassword").val()!=$("#J_password").val()||$("#J_repassword").val()==''){$("#J_repasswordTip").css("display",'inline-block');f=0;}
		if(f==0){return false;}
	});
	$("#J_password").blur(function(){if($("#J_password").val().length<6){$("#J_passwordTip").css("display",'inline-block');}else{$("#J_passwordTip").hide();}});
	$("#J_repassword").blur(function(){
		if($("#J_repassword").val()!=$("#J_password").val()||$("#J_repassword").val()==''){$("#J_repasswordTip").css("display",'inline-block');}else{$("#J_repasswordTip").hide();}
	});
	//刷新验证码
