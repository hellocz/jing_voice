...
<div class="w_gezx_ce"> 
  ...
  <div class="w_ger">
    ...
    <div class="w_xxzx_t">
           <span class="w_xxzx_t_s"  id="xxx2" onclick="window.location='<?php echo U('message/system');?>'">系统提醒</span>   

        <span  id="xxx1" onclick="window.location='<?php echo U('message/index');?>'">菜友消息</span>
    </div>
	...
	<div class="mes_friendly">
		...
		<?php if($system_list != ''): ?><ul class="system">
                ...
                <?php if(is_array($system_list)): $i = 0; $__LIST__ = $system_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
                    ...
                    <a href="javascript:" class="sys_time fr xx_ss"  data-id = "<?php echo ($val["id"]); ?>"><span  style="margin-left: 10px;">删除</span></a>
...
<script>
    ...
    $('.xx_ss').click(function(){

        $.get(PINER.root + '/message-del-mid-' + $(this).data('id'),function(result){
