  ...
  <div class="w_cen_lef">
	...
	<div  class="w_yhj2">
	 ...
	 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li <?php if($i%2 == 1): ?>class="no_left"<?php endif; ?>>
         <a href="<?php echo U('tick/show',array('id'=>$r['id']));?>" title=""><img src="<?php echo attach($r['img'],'item_orig');?>" title="<?php echo ($r["name"]); ?>" alt="<?php echo ($r["name"]); ?>"/></a>
         ...
         <div><a href="<?php echo U('tick/show',array('id'=>$r['id']));?>" title="立即领取">立即领取</a></div>
       </li><?php endforeach; endif; else: echo "" ;endif; ?>
     </ul>
    </div>
	<?php if($page): ?><div class="w_pag"><?php echo ($pagebar); ?></div><?php endif; ?>
  </div>
  <div class="w_cen_rig ">
    <div class="w_r5">
     <h2>热门优惠劵</h2>
